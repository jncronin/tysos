...
#    define mach_type_known
# endif
# if defined(TYSOS) && (defined(i386) || defined(__i386__))
#    define I386
#    define mach_type_known
# endif
# if defined(TYSOS) && defined(__x86_64__)
#    define X86_64
#    define mach_type_known
# endif
# if defined(TYSOS) && (defined(__arm) || defined(__arm__))
#    define ARM32
#    define mach_type_known
# endif
...
#   endif
#   ifdef TYSOS
#		define OS_TYPE "TYSOS"
		extern int _start[];
#define	DATASTART (ptr_t)(_start)
		extern int _edata[];
#define DATAEND (ptr_t)(_edata)
#	endif
#   ifdef THREE86BSD
