...
#ifdef TYSOS
/* Tysos does not implement environment variables */
...
/* We define exit (which is only used here) to be abort */
...
/* Provide some simple library functions for Tysos */
...
/* atoi(), atol() and strtoul() are used to parse the response of getenv - which always returns NULL on Tysos */
...
/* write() is used for logging functions, we don't provide it */
