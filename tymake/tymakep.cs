...
// UserName: jncronin
// Input file <tymake.y - 28/11/2014 20:28:33>
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[17] = new State(new int[]{28,18,27,-66,7,-66,12,-66,23,-66,20,-66,21,-66});
    ...
    states[20] = new State(new int[]{29,21,28,-68,27,-68,7,-68,12,-68,23,-68,20,-68,21,-68});
    ...
    states[23] = new State(new int[]{30,24,29,-70,28,-70,27,-70,7,-70,12,-70,23,-70,20,-70,21,-70});
    ...
    states[26] = new State(new int[]{31,27,30,-72,29,-72,28,-72,27,-72,7,-72,12,-72,23,-72,20,-72,21,-72});
    ...
    states[29] = new State(new int[]{3,30,17,88,31,-75,30,-75,29,-75,28,-75,27,-75,7,-75,12,-75,23,-75,20,-75,21,-75});
    ...
    states[32] = new State(new int[]{25,33,26,82,18,84,19,86,3,-80,17,-80,31,-80,30,-80,29,-80,28,-80,27,-80,7,-80,12,-80,23,-80,20,-80,21,-80});
    ...
    states[35] = new State(new int[]{9,36,10,80,25,-83,26,-83,18,-83,19,-83,3,-83,17,-83,31,-83,30,-83,29,-83,28,-83,27,-83,7,-83,12,-83,23,-83,20,-83,21,-83});
    ...
    states[38] = new State(new int[]{5,39,9,-85,10,-85,25,-85,26,-85,18,-85,19,-85,3,-85,17,-85,31,-85,30,-85,29,-85,28,-85,27,-85,7,-85,12,-85,23,-85,20,-85,21,-85});
    ...
    states[46] = new State(new int[]{24,47,5,-89,9,-89,10,-89,25,-89,26,-89,18,-89,19,-89,3,-89,17,-89,31,-89,30,-89,29,-89,28,-89,27,-89,7,-89,12,-89,23,-89,20,-89,21,-89});
    states[47] = new State(new int[]{61,49},new int[]{-17,48,-15,58});
    states[48] = new State(-10);
    states[49] = new State(new int[]{6,50,24,-11,5,-11,9,-11,10,-11,25,-11,26,-11,18,-11,19,-11,3,-11,17,-11,31,-11,30,-11,29,-11,28,-11,27,-11,7,-11,12,-11,23,-11,20,-11,21,-11,38,-11,39,-11,40,-11});
    ...
    states[135] = new State(new int[]{53,55,61,49},new int[]{-13,136,-16,56,-17,57,-15,58});
    states[136] = new State(new int[]{24,47,38,154,39,-43,40,-43,20,-43},new int[]{-37,137});
    ...
    rules[38] = new Rule(-24, new int[]{37,-13,-37,-36,-18});
...
{ CurrentSemanticValue.stmtval = new DoBlock { test = ValueStack[ValueStack.Depth-2].exprval, code = ValueStack[ValueStack.Depth-5].stmtval }; }
        break;
      case 38: // makerule -> RULEFOR, strlabelexpr, inputsstmt, dependsstmt, stmtblock
#line 116 "tymake.y"
